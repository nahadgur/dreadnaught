...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      <section className="relative min-h-screen w-full pt-32 pb-24 px-6 md:px-12 lg:px-24 overflow-hidden">
        {/* Background */}
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <motion.p
              ...
              className="text-white/70 font-sans max-w-md text-sm md:text-base lg:text-lg leading-relaxed mb-12"
            >
