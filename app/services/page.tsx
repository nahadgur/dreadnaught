  ...
  return (
    <main className="min-h-screen bg-black text-white">
      <PageHero
        ...
        subtitle="We are a premier digital agency in London, specializing in high-end web development, immersive brand identities, and SEO-driven growth strategies."
      />
